...
const updateData = (product) => {
    form.category = category.value
        ? category.value.id
        : product.category_id;
    form.manufacturer = manufacturer.value ? manufacturer.value.id : product.manufacturer_id;
...
<template>
    <AppLayout title="Products">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <FormSection @submitted="updateData(product)">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <div class="dropdown relative mt-2 w-full">
                            <button ref="manufacturerInput"
                                ...
                                {{
                                        manufacturer ? manufacturer.name : product.manufacturer_name
                                }}
                                <div class="w-full flex justify-end">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-down"
                                        class="w-2 ml-2" role="img" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <TextInput id="name" ref="nameInput" v-model="product.name" type="text"
                            class="mt-1 block w-full" />
                        <InputError :message="form.errors.name" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="stock" value="Ramen Stock" />
                        <TextInput id="stock" ref="stockInput" v-model="product.stock" type="number"
                            class="mt-1 block w-full" />
                        <InputError :message="form.errors.stock" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="price" value="Ramen Price" />
                        <TextInput id="price" ref="priceInput" v-model="product.price" type="number"
                            class="mt-1 block w-full" />
