            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="w-full flex">
                    <div class="w-1/2">
                        ...
                        <Link :href="route('products.trashed')">
                    ...
                    <div class="w-1/2">
                        <TextInput id="search" type="text" class="block w-full" placeholder="Search Product..."
                            ...
                            <div class="inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="bg-zinc-50 border-b" v-if="products.length > 0"
